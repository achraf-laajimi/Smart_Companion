    ...
    <Navbar bg="primary" expand="lg" fixed="top" className="w-100">
      ...
      <Navbar.Collapse id="basic-navbar-nav">
        <Nav className="me-auto">
          <Nav.Link href="#app-properties" className="text-white">
            <FaCog className="me-2" />
            App Properties
          </Nav.Link>
          <Nav.Link href="#user-views" className="text-white">
            <FaUser className="me-2" />
            User Views
          </Nav.Link>
          <Nav.Link href="#parent-space" className="text-white">
            <FaHome className="me-2" />
            Parent Space
          </Nav.Link>
          <Nav.Link href="#user-guide" className="text-white">
            <FaBook className="me-2" />
            User Guide
          </Nav.Link>
          <Nav.Link href="#competition" className="text-white">
            <FaTrophy className="me-2" />
            Competition Section
          </Nav.Link>
          <Nav.Link href="#class-quiz-stories" className="text-white">
